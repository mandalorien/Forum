...
use UserBundle\Form\ResetRequestType;
...
class SecurityController  extends BaseController
{
     ...
     * @Template("UserBundle:Core:login.html.twig")
    ...
    /**
     * @Template("UserBundle:Core:register.html.twig")
     * @Role("is_granted('IS_AUTHENTICATED_ANONYMOUSLY')")
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $users = $em->getRepository('UserBundle:Users')->findOneByConfirmationToken($token);
    ...
    /**
     * @Template("UserBundle:Core:password.reset.request.html.twig")
     * @Role("is_granted('IS_AUTHENTICATED_ANONYMOUSLY')")
    ...
    /**
     * @Template("UserBundle:Core:password.confirm.email.html.twig")
     * @Role("is_granted('IS_AUTHENTICATED_ANONYMOUSLY')")
     * @return array
     */
    ...
    /**
     * @Template("UserBundle:Core:logout.html.twig")
